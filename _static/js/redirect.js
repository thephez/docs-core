...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var replacements = [
    { pattern: /^\/projects\/core\/en\/stable\/docs\//, replacement: '/en/stable/docs/core/' },
    { pattern: /^\/projects\/core\/en\/stable\//, replacement: '/en/stable/docs/core/' },
    { pattern: /^\/projects\/core\/en\/22.0.0\/docs\//, replacement: '/en/22.0.0/docs/core/' },
    { pattern: /^\/projects\/core\/en\/22.0.0\//, replacement: '/en/22.0.0/docs/core/' },
