...
>
> Parts of this command have been deprecated and moved to the [getaddressinfo RPC](../api/remote-procedure-calls-wallet.md#getaddressinfo). Clients must transition to using `getaddressinfo` to access this information.
