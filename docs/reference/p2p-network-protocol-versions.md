...
|---------|------------------------------------|--------------
| 70230 | [Dash Core 20.0](https://github.com/dashpay/dash/blob/v20.0.0/doc/release-notes.md) <br> (Nov 2023) | • [DIP 29](https://github.com/dashpay/dips/blob/master/dip-0028.md): ChainLock-based random beacon<br>• Treasury expansion<br>• Sentinel functionality integrated into Core<br> • Asset lock transactions
