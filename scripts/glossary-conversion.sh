...
find . -iname "*.md" -exec sed -i 's~<<glossary:ecdsa-signatures>>~[ecdsa-signatures](../resources/glossary.md#ecdsa-signatures)~g' {} +
...
find . -iname "*.md" -exec sed -i 's~<<glossary:hardened-extended-private-key>>~[hardened-extended-private-key](../resources/glossary.md#hardened-extended-private-key)~g' {} +
...
find . -iname "*.md" -exec sed -i 's~<<glossary:headers-first-sync>>~[headers-first-sync](../resources/glossary.md#headers-first-sync)~g' {} +
...
find . -iname "*.md" -exec sed -i 's~<<glossary:pay-to-pubkey-hash>>~[pay-to-pubkey-hash](../resources/glossary.md#pay-to-pubkey-hash)~g' {} +
find . -iname "*.md" -exec sed -i 's~<<glossary:pay-to-script-hash>>~[pay-to-script-hash](../resources/glossary.md#pay-to-script-hash)~g' {} +
